...
def main():
    res_path = "/home/sun/code/generate_report/code/R2Gen-mamba/results/mimic_cxr_0912/res_chexbert.csv"
    gts_path = "/home/sun/code/generate_report/code/R2Gen-mamba/results/mimic_cxr_0912/gts_chexbert.csv"
