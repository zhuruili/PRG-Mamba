...
def parse_agrs():
    ...
    parser.add_argument('--load', type=str, default='/home/sun/code/generate_report/code/R2Gen-mamba/results/mimic_cxr_0912/model_best.pth', help='whether to load a pre-trained model.')
...
def main():
    ...
    model = model.encoder_decoder.model.encoder
    model.cuda()

    # from fvcore.nn import FlopCountAnalysis
    # # 输入的张量（示例：8个 3x32x32 的图片）
    ...
    # 假设输入图像的形状是 (2, 3, 224, 224)
    input_size = (1, 3, 224, 224)  # 根据你的实际输入调整这个形状
    macs, params = get_model_complexity_info(model.cuda(), input_size, as_strings=True, print_per_layer_stat=False)
